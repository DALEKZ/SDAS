...
# 参考: https://github.com/double-point/craw_project/blob/master/craw_tools/get_ua.py
...
from data_util.craw_tool.get_ua import get_ua
...
if __name__ == '__main__':
    ...
    """保存数据"""
    df_rank_data.to_csv('E:\\PycharmProjects\\SDAS\\file\\' + fund_type + '_型基金收益详情.csv', encoding='gbk', index=False)
    #df_position_data.to_csv('E:\\PycharmProjects\\SDAS\\file\\' + fund_type + '_型基金近一年Top' + str(max_rank) + '前十大持仓.csv', encoding='gbk',
    #                       index=False)
